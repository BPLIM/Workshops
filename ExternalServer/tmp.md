...
papersize: a4
fontsize: 11pt
header-includes: \usepackage[paperwidth=210mm,paperheight=297mm,left=27mm,right=27mm,top=25mm,bottom=25mm]{geometry}
  \usepackage{hyperref} \hypersetup{colorlinks=true} \hypersetup{citecolor=black}
  \hypersetup{linkcolor=blue!75!black} \hypersetup{urlcolor=blue!75!black} \hypersetup{filecolor=blue!75!black}
  \hypersetup{citecolor=black} \usepackage{float} \usepackage{dcolumn} \usepackage{color}
...
pandoc --toc --number-sections tmp.md --pdf-engine=xelatex -o tmp.pdf
