...
> **Version of the data**: The data made available by BPLIM corresponds to a data freeze at a certain time of the year.[^3] Therefore, all files contain the information as reported in the extraction date. The most recent update of the data occurred in June 2023.
...
> **Digital Object Identifier**: 10.17900/CB.CBA.Jun2023.V1
...
Every year around the month of June, after the quality control process takes place, BPLIM creates a data freeze. The most recent version of the data was extracted on June 2023 and includes data from 2006 to 2021.
...
The main changes introduced in the extraction of *June 2023* relatively to the previous one (*June 2022*) are:

1. **General Information File** [^36]

    - There is a new variable available (*unipessoal*) that allows to identify companies under the legal form "Single Holder Private Limited Company" (*Sociedade unipessoal por quotas*);
    
    - The variable *sectorinstfinal* (Institutional sector) was recoded and follows a new classification.

[^36]: For more detailed information see the description of the variables in the [General Information File](#general-information-file).
...
Where *A* stands for Anonymized and *yyyy*=2006,…,2021 and *eeee* reports the extraction date.
...
`District` (*distrito*) – provides information on the district in which the firm is located. The classification of this variable is according to *DICOFRE* and differs from the [Code of the administrative division](http://smi.ine.pt/Versao/Detalhes/17) for Autonomous Regions. For a complete list of codes see the metadata file [CB_meta_YFRM_JUN23_ROSTO_V01](./aux_files/metafiles/CB_meta_YFRM_JUN23_ROSTO_V01.xlsx).
...
For a complete list of codes see the variables *cae21* and *cae3* in the metadata file [CB_meta_YFRM_JUN23_ROSTO_V01](./aux_files/metafiles/CB_meta_YFRM_JUN23_ROSTO_V01.xlsx).
...
Table 2- Number of firms over the data period (as of June 2023 extraction) 
...
forval yy=`startyr'/`finyear' {
    quietly append using "S:/data/Products/CB/`ref'/CB_Annual/Output/Data/Firms/`yy'/CB_I_`file1'_`yy'_`extraction'_ROSTO_`version'.dta"
}
...
For a description of each variable in each dataset (metafiles), summary statistics and a codebook for each data set please check the following auxiliary files[^32]:

| File | Metafiles | Variable description | Summary Statistics | Codebook | Dataset Description |
| :--- | :---: | :---: | :---: | :---: | :---: |
| General Information | [meta_ROSTO](./aux_files/metafiles/CB_meta_YFRM_JUN23_ROSTO_V01.xlsx) | [var_ROSTO](./aux_files/variables_description/var_rosto.html) | [stat_ROSTO](./aux_files/descriptive_statistics/CB_stat_ROSTO.html) | [cdbk_ROSTO](./aux_files/codebook/CB_cdbk_ROSTO.html) | [dscr_ROSTO](./aux_files/describe_dataset/CB_dscr_ROSTO.html) |
| Economic and Financial Information | [meta_CONTAS](./aux_files/metafiles/CB_meta_YFRM_JUN23_CONTAS_V01.xlsx) | [var_CONTAS](./aux_files/variables_description/var_contas.html) | [stat_CONTAS](./aux_files/descriptive_statistics/CB_stat_CONTAS.html) | [cdbk_CONTAS](./aux_files/codebook/CB_cdbk_CONTAS.html) | [dscr_CONTAS](./aux_files/describe_dataset/CB_dscr_CONTAS.html) |
| Employment Information | [meta_PESSOAL](./aux_files/metafiles/CB_meta_YFRM_JUN23_PESSOAL_V01.xlsx) | [var_PESSOAL](./aux_files/variables_description/var_pessoal.html) | [stat_PESSOAL](./aux_files/descriptive_statistics/CB_stat_PESSOAL.html) | [cdbk_PESSOAL](./aux_files/codebook/CB_cdbk_PESSOAL.html) | [dscr_PESSOAL](./aux_files/describe_dataset/CB_dscr_PESSOAL.html) |
| Trade Information per Market | [meta_MG](./aux_files/metafiles/CB_meta_YFRM_JUN23_MG_V01.xlsx) | [var_MG](./aux_files/variables_description/var_mg.html) | [stat_MG](./aux_files/descriptive_statistics/CB_stat_MG.html) | [cdbk_MG](./aux_files/codebook/CB_cdbk_MG.html) | [dscr_MG](./aux_files/describe_dataset/CB_dscr_MG.html) |
| Corporate Actions | [meta_AMARC](./aux_files/metafiles/CB_meta_YFRM_JUN23_AMARC_V01.xlsx) | [var_AMARC](./aux_files/variables_description/var_amarc.html) | [stat_AMARC](./aux_files/descriptive_statistics/CB_stat_AMARC.html) | [cdbk_AMARC](./aux_files/codebook/CB_cdbk_AMARC.html) | [dscr_AMARC](./aux_files/describe_dataset/CB_dscr_AMARC.html) |
| Economic and Financial Indicators | [meta_INDIC](./aux_files/metafiles/CB_meta_YFRM_JUN23_INDIC_V01.xlsx) | [var_INDIC](./aux_files/variables_description/var_indic.html) | [stat_INDIC](./aux_files/descriptive_statistics/CB_stat_INDIC.html) | [cdbk_INDIC](./aux_files/codebook/CB_cdbk_INDIC.html) | [dscr_INDIC](./aux_files/describe_dataset/CB_dscr_INDIC.html) |
| Cash Flows | [meta_CF](./aux_files/metafiles/CB_meta_YFRM_JUN23_FLUXOSCAIXA_V01.xlsx) | [var_CF](./aux_files/variables_description/var_cashflow.html) | [stat_CF](./aux_files/descriptive_statistics/CB_stat_FLUXOSCAIXA.html) | [cdbk_CF](./aux_files/codebook/CB_cdbk_FLUXOSCAIXA.html) | [dscr_CF](./aux_files/describe_dataset/CB_dscr_FLUXOSCAIXA.html) |
| Information by Sector of Activity | [meta_BYCAE](./aux_files/metafiles/CB_meta_YFRM_JUN23_BYCAE_V01.xlsx) | [var_BYCAE](./aux_files/variables_description/var_bycae.html) | [stat_BYCAE](./aux_files/descriptive_statistics/CB_stat_BYCAE.html) | [cdbk_BYCAE](./aux_files/codebook/CB_cdbk_BYCAE.html) | [dscr_BYCAE](./aux_files/describe_dataset/CB_dscr_BYCAE.html) |
