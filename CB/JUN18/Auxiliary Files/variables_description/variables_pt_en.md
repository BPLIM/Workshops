...
5. [Economic and Financial Indicators File](#economic-and-financial-indicators-file)
6. [Cash-Flows File](#cash-flows-file)
7. [Information by Sector of Activity File](#information-by-sector-of-activity-file)
...
| Variable | Designação |	Designation |
| ------- | ------------| --------------|
| VF05681 | **Activo Total (Contabilístico, igual a Capital Próprio e Passivo)** | **Total Assets** |
| VF05737 | > **Imobilizações Corpóreas e Incorpóreas (Exclui Imobilizações em Curso)** | > **Tangible and intangible assets (excluding fixed assets work-in-progress)** |
| VF05739 | > > Imobilizações Incorpóreas | > > Intangible assets |
| VF05743 | > > Imobilizações Corpóreas | > > Tangible fixed assets |
| VF05750 | > **Imobilizações em Curso (Inclui Incorpóreas, Corpóreas e Investimentos Financeiros)** | > **Fixed assets work-in-progress (including tangible, intangible and financial investments)** |
| VF05685 | > **Investimentos Financeiros** | > **Financial Assets** |
| VF05751 | > **Existências** | > **Current Assets - Inventories** |
| VF05759 | > > Existências de Produtos Acabados e Intermédios; Subprodutos, desperdícios, Resíduos e Refugos; Produtos e Trabalhos em Curso | > > Current Assets - Inventories - Finished and intermediate products; Subproducts, wastes and scrap; Products and work in progress) |
| VF03141 | > > Circulante - Existências - Matérias primas, subsidiárias e de consumo - Activo bruto | > > Current Assets - Inventories - Raw and subsidiary materials and consumables - Gross Assets |
| VF03153 | > > Circulante - Existências - Mercadorias - Activo bruto | > > Current Assets - Inventories - Goods - Gross Assets |
| VF05696 | > **Outros Créditos Concedidos** | > **Other Debts** |
| VF05709 | > > Outras Dívidas de Terceiros | > > Other debts |
| VF05763 | > > Acréscimos e Diferimentos (Activos) | > > Accruals and deferrals (Assets) |
| VF03156 | > > Circulante - Existências - Adiantamentos por conta de compras | > > Current Assets - Inventories - Advances for purchases |
| VF05700 | > > Outros Créditos Concedidos - Créditos Comerciais e Adiantamentos | > > Other Loans Granted - Trade Credit and Advances |
| VF05702 | > > > Clientes | > > > Client debts |
| VF05822 | > > > Adiantamentos de Clientes | > > > Advances from clients |
| VF05697 | > > *Dívidas de Terceiros CP* | > > *Short-term accounts receivable* |
| VF03253 | > **(Total de amortizações)** | > **(Total depreciation)** |
| VF03254 | > **(Total de ajustamentos)** | > **(Total adjustments)** |
| VF03242 | > **Circulante - Títulos negociáveis - Total do activo bruto** | > **Current Assets - Negotiable securities - Gross Assets** |
| VF03247 | > **Circulante - Depósitos bancários e caixa** | > **Current Assets - Cash and cash equivalents** |
| VF03088 | Imobilizado - Imobilizações incorpóreas - Total do activo líquido | Intangible assets - Net Assets |
| VF03117 | Imobilizado - Imobilizações corpóreas - Total do activo líquido | Tangible fixed assets - Net Assets |
| VF03140 | Imobilizado - Investimentos financeiros - Total do activo líquido | Financial Assets - Net Assets |
| VF05753 | Existências (Valor Líquido - BACH) | Inventories - Net Assets (BACH) |
| VF05762 | Outras Existências (Valor Líquido - BACH) | Other Inventories - Net Assets (BACH) |
| VF03143 | Circulante - Existências - Matérias primas, subsidiárias e de consumo - Activo líquido | Current Assets - Inventories - Raw and subsidiary materials and consumables - Net Assets |
| VF05701 | Créditos Comerciais Concedidos (Valor Líquido - BACH) | Trade Credits Granted - Net Assets (BACH) |
| VF05710 | Outras Dívidas de Terceiros (Valor Líquido - BACH) | Other accounts receivable - Net Assets (BACH) |
| VF03223 | Circulante - Dívidas de terceiros - Curto prazo - Total do activo líquido | Short-term accounts receivable - Net Assets |
| VF03244 | Circulante - Títulos negociáveis - Total do activo líquido | Current Assets - Negotiable securities - Net Assets |
| VF05773 | **Capital Próprio** | **Total Equity** |
| VF05775 | > **Acções e Outras Participações - Contas de Capital** | > **Shares and other Equity - Capital Accounts** |
...
| VF16005 | > > > > Activo não corrente - Outros activos fixos tangíveis | > > > > Non-current assets-Other fixed assets |
...
| VF13032 | > > > Outras variações no capital próprio - R4 | > > > Other variations in equity- R4 |
...
| VF03020 | **Fornecimentos e serviços externos** | **Supplies and external services** |
...
| VF16175 | **Outros gastos e perdas (QS)** | **Other expenses** |
...
| VF04903	| Nota 7 - Nº  médio de pessoas remuneradas ao serviço da empresa a tempo completo	| Number of paid full-time employees |
...
| VF15564	| Indemnizações | Compensations/indemnities |
...
| VF15629 | Compras - Mercado Extra-comunitário | Extra-EU Market - Total purchases |
...
| Variable | Designação | Designation |
| ------- | ------------| --------------|
| VF13265 | Fluxos de caixa das actividades operacionais - Recebimentos de clientes | Cash flows from operating activities - Cash receipts from customers |
| VF13266 | Fluxos de caixa das actividades operacionais - Pagamentos a fornecedores | Cash flows from operating activities - Cash payments to suppliers |
| VF13267 | Fluxos de caixa das actividades operacionais - Pagamentos ao pessoal | Cash flows from operating activities - Cash payments to employees |
| VF13268 | Fluxos de caixa das actividades operacionais - Total Caixa gerada pelas operações | Total cash generated by operating activities |
| VF13269 | Fluxos de caixa das actividades operacionais - Pagamento/recebimento do imposto sobre o rendimento | Cash flows from operating activities - Cash payments/receipts from income tax |
| VF13270 | Fluxos de caixa das actividades operacionais - Outros recebimentos/pagamentos | Cash flows from operating activities - Other cash payments/receipts |
| VF13271 | Total dos Fluxos de caixa das actividades operacionais | Total cash flow from operating activities |
| VF13272 | Fluxos de caixa das actividades de investimento - Pagamentos respeitantes a Activos fixos tangíveis | Cash flows from investing activities  - Cash payments relating to tangible fixed assets |
| VF13273 | Fluxos de caixa das actividades de investimento - Pagamentos respeitantes a Activos intangíveis | Cash flows from investing activities -Cash payments relating to intangible assets |
| VF13274 | Fluxos de caixa das actividades de investimento - Pagamentos respeitantes a  Invest. financeiros | Cash flows from investing activities - Cash payments relating to financial fixed assets |
| VF13275 | Fluxos de caixa das actividades de investimento - Pagamentos respeitantes a Outros activos | Cash flows from investing activities - Cash payments relating to other assets |
| VF13276 | Fluxos de caixa das actividades de investimento -Recebimentos provenientes de Activos fixos tangíveis | Cash flows from investing activities -Cash receipts from tangible fixed assets |
| VF13277 | Fluxos de caixa das actividades de investimento - Recebimentos provenientes de  Activos intangíveis | Cash flows from investing activities - Cash receipts from intangible assets |
| VF13278 | Fluxos de caixa das actividades de investimento - Recebimentos provenientes de Invest. financeiros | Cash flows from investing activities - Cash receipts from financial fixed assets |
| VF13279 | Fluxos de caixa das actividades de investimento - Recebimentos provenientes de Outros activos | Cash flows from investing activities -Cash receipts from other assets |
| VF13280 | Fluxos de caixa das actividades de investimento - Recebimentos provenientes de Subsídios ao investimento | Cash flows from investing activities - Cash receipts from investment subsidies |
| VF13281 | Fluxos de caixa das actividades de investimento - Recebimentos provenientes de Juros e rendimentos similares | Cash flows from investing activities - Cash receipts from interest income |
| VF13282 | Fluxos de caixa das actividades de investimento - Recebimentos provenientes de Dividendos | Cash flows from investing activities - Cash receipts from dividends |
| VF13283 | Total dos Fluxos de caixa das actividades de investimento | Total cash flow from investing activities |
| VF13284 | Fluxos de caixa das activ.  financiamento - Recebimentos provenientes de Financ. obtidos | Cash flows from financing activities - Cash receipts from obtained funding |
| VF13285 | Fluxos de caixa das activ. financiamento - Recebimentos provenientes de Realizações de capital e de outros instrumentos de capital próprio | Cash flows from financing activities -Cash receipts from paid-up capital and other equity instruments |
| VF13286 | Fluxos de caixa das activ. financiamento - Recebimentos provenientes de Cobertura de prejuízos | Cash flows from financing activities - Cash receipts from loss coverage |
...
| VF04125 | Variação da produção por actividade | Variation in production by sector |
