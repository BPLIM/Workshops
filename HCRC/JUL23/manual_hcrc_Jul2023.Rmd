...
opts_knit$set(root.dir = "Z:/data/Products/HCRC/2023_06/HCRC_Annual/Output/Data/Firms/")
...
quietly use "Z:/data/Products/HCRC/`ref'/HCRC_Annual/Output/Data/Firms/2009/External/HCRC_C_`file1'_2009_`extraction'_COBR_`version'.dta", clear

forval i=2010/2022 {
  quietly append using "Z:/data/Products/HCRC/`ref'/HCRC_Annual/Output/Data/Firms/`i'/External/HCRC_C_`file1'_`i'_`extraction'_COBR_`version'.dta"
...
quietly use "Z:/data/Products/HCRC/`ref'/HCRC_Annual/Output/Data/Firms/2009/Auxiliar/HCRC_C_`file2'_2009_`extraction'_CO_`version'.dta", clear

forval i=2010/2022 {
  quietly append using "Z:/data/Products/HCRC/`ref'/HCRC_Annual/Output/Data/Firms/`i'/Auxiliar/HCRC_C_`file2'_`i'_`extraction'_CO_`version'.dta"
  quietly keep if month(dofm(date))==12
