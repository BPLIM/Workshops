...
> **Data Organization**: Data is organized in five files:
  ...
  In all files each row corresponds to one firm in a given year. [^1] All files are available in Stata format, version 17.

> **Version of the Data**: The data made available by BPLIM corresponds to a data freeze at a certain time of the year.[^2] Therefore, all files contain the information as reported in the extraction date. The most recent update of the data occurred in June 2023.
...
> **Digital Object Identifier**: 10.17900/CB.CBHP.Jun2023.V1

> **New in this extraction**: variable *unipessoal* (Single Holder Private Limited Company) is now available. The variable *sectorinstfinal* (Institutional sector) follows a new classification. An R script to compute the Economic and Financial Indicators is also available.
...
The population of the CBHP is the same as in the annual data, i.e. the population of all Portuguese non-financial corporations. For more information, please see the manual on [*Central Balance Sheet Database (CB) - Annual Data*](../../CB/Jun2023/Pack_CB_Empresas_Jun23/CB_manual_Jun2023.html).
...
| :----------- | :-----------: | :------: |
| General Information (Cover Sheet) File	| 27 | 2006-2021 |
| Economic and Financial Information File | 62 | 2006-2021 |
| Employment Information File | 20 | 2006-2021 |
| Trade Information per Market File | 14 | 2006-2021 |
| Corporate Actions | 10 | 2006-2021 |
...
`District` (*distrito*) – provides information on the district in which the firm is located. The classification of this variable is according to *DICOFRE* and differs from the [Code of the administrative division](http://smi.ine.pt/Versao/Detalhes/17) for Autonomous Regions. For a complete list of codes see the metadata file [CBHP_meta_YFRM_JUN23_ROSTO_V01](./aux_files/metafiles/CBHP_meta_YFRM_JUN23_ROSTO_V01.xlsx).
...
Table 2- Firm flows (as of June 2023 extraction) 
...
*| output: true
*| echo: false
quietly use "S:/data/Products/CB/`ref'/CB_Panel/Output/Data/Firms/CBHP_I_`file1'_`startyr'`finyear'_`extraction'_ROSTO_`version'.dta", clear
...
| File | Metafiles | Summary Statistics | Codebook | Dataset description | Report |
| :--- | :---: | :---: | :---: | :---: | :---: |
| General Information | [meta_ROSTO](./aux_files/metafiles/CBHP_meta_YFRM_JUN23_ROSTO_V01.xlsx) | [stat_ROSTO](./aux_files/descriptive_statistics/CBHP_stat_ROSTO.html) | [cdbk_ROSTO](./aux_files/codebook/CBHP_cdbk_ROSTO.html) | [dscr_ROSTO](./aux_files/describe_dataset/CBHP_dscr_ROSTO.html) | |
| Economic and Financial Information | [meta_CONTAS](./aux_files/metafiles/CBHP_meta_YFRM_JUN23_CONTAS_V01.xlsx) | [stat_CONTAS](./aux_files/descriptive_statistics/CBHP_stat_CONTAS.html) | 	[cdbk_CONTAS](./aux_files/codebook/CBHP_cdbk_CONTAS.html) | [dscr_CONTAS](./aux_files/describe_dataset/CBHP_dscr_CONTAS.html) | [rprt_CONTAS](./aux_files/technical_reports/report_JUN23_CONTAS20062021.html) |
| Employment Information | [meta_PESSOAL](./aux_files/metafiles/CBHP_meta_YFRM_JUN23_PESSOAL_V01.xlsx) | [stat_PESSOAL](./aux_files/descriptive_statistics/CBHP_stat_PESSOAL.html) | [cdbk_PESSOAL](./aux_files/codebook/CBHP_cdbk_PESSOAL.html) | [dscr_PESSOAL](./aux_files/describe_dataset/CBHP_dscr_PESSOAL.html) | [rprt_PESSOAL](./aux_files/technical_reports/report_JUN23_PESSOAL20062021_VS_CONTAS20062021.html) |
| Trade Information per Market | [meta_MG](./aux_files/metafiles/CBHP_meta_YFRM_JUN23_MG_V01.xlsx) | [stat_MG](./aux_files/descriptive_statistics/CBHP_stat_MG.html) | [cdbk_MG](./aux_files/codebook/CBHP_cdbk_MG.html) | [dscr_MG](./aux_files/describe_dataset/CBHP_dscr_MG.html) | [rprt_MG](./aux_files/technical_reports/report_JUN23_MG20062021_VS_CONTAS20062021.html) |
| Corporate Actions | [meta_AMARC](./aux_files/metafiles/CBHP_meta_YFRM_JUN23_AMARC_V01.xlsx) | [stat_AMARC](./aux_files/descriptive_statistics/CBHP_stat_AMARC.html) | [cdbk_AMARC](./aux_files/codebook/CBHP_cdbk_AMARC.html) | [dscr_AMARC](./aux_files/describe_dataset/CBHP_dscr_AMARC.html) | |

[^32]: The metafiles, summary statistics, codebook and dataset description files are available on BPLIM's servers.
