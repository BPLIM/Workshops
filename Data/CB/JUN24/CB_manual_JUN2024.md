...
> **Version of the data**: The data made available by BPLIM corresponds to a data freeze at a certain time of the year.[^3] Therefore, all files contain the information as reported in the extraction date. The most recent update of the data occurred in June 2024.
...
> **Digital Object Identifier**: 10.17900/CB.CBA.Jun2024.V1
...
1. **General Information File** [^36]
    ...
    - District (*distrito*) is replaced by a new variable with more detailed information on the location of the firm at the municipality level (*concelho*).

[^36]: For more detailed information see the description of the variables in the [General Information File](#a.-general-information-file-cover-sheet).
...
`Municipality` (*concelho*) – provides information on the municipality in which the firm is located. The classification of this variable is according to *DICOFRE* and differs from the [Code of the administrative division](http://smi.ine.pt/Versao/Detalhes/17) for Autonomous Regions. For a complete list of codes see the metadata file [CB_meta_YFRM_JUN24_ROSTO_V01](./aux_files/metafiles/CB_meta_YFRM_JUN24_ROSTO_V01.xlsx).
...
| File | Metafiles | Variable description | Summary Statistics |
| :--- | :---: | :---: | :---: |
| General Information | [meta_ROSTO](./aux_files/metafiles/CB_meta_YFRM_JUN24_ROSTO_V01.xlsx) | [var_ROSTO](./aux_files/variables_description/var_rosto.html) | [stat_ROSTO](./aux_files/descriptive_statistics/) |
| Economic and Financial Information | [meta_CONTAS](./aux_files/metafiles/CB_meta_YFRM_JUN24_CONTAS_V01.xlsx) | [var_CONTAS](./aux_files/variables_description/var_contas.html) | [stat_CONTAS](./aux_files/descriptive_statistics/) |
| Employment Information | [meta_PESSOAL](./aux_files/metafiles/CB_meta_YFRM_JUN24_PESSOAL_V01.xlsx) | [var_PESSOAL](./aux_files/variables_description/var_pessoal.html) | [stat_PESSOAL](./aux_files/descriptive_statistics/) |
| Trade Information per Market | [meta_MG](./aux_files/metafiles/CB_meta_YFRM_JUN24_MG_V01.xlsx) | [var_MG](./aux_files/variables_description/var_mg.html) | [stat_MG](./aux_files/descriptive_statistics/) |
| Corporate Actions | [meta_AMARC](./aux_files/metafiles/CB_meta_YFRM_JUN24_AMARC_V01.xlsx) | [var_AMARC](./aux_files/variables_description/var_amarc.html) | [stat_AMARC](./aux_files/descriptive_statistics/) |
| Economic and Financial Indicators | [meta_INDIC](./aux_files/metafiles/CB_meta_YFRM_JUN24_INDIC_V01.xlsx) | [var_INDIC](./aux_files/variables_description/var_indic.html) | [stat_INDIC](./aux_files/descriptive_statistics/) |
| Cash Flows | [meta_CF](./aux_files/metafiles/CB_meta_YFRM_JUN24_FLUXOSCAIXA_V01.xlsx) | [var_CF](./aux_files/variables_description/var_cashflow.html) | [stat_CF](./aux_files/descriptive_statistics/) |
| Information by Sector of Activity | [meta_BYCAE](./aux_files/metafiles/CB_meta_YFRM_JUN24_BYCAE_V01.xlsx) | [var_BYCAE](./aux_files/variables_description/var_bycae.html) | [stat_BYCAE](./aux_files/descriptive_statistics/) |
