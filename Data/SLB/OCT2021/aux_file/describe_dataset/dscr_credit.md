...
```s/
di _new _new "SLB - Credit Variables - 1990"
quietly use "Z:/data/Products/SLB/2021_10/Output/Data/SLB_C_YBNK_19902020_OCT21_QB1_V01.dta", clear
quietly keep if year== 1990
describe

di _new _new "SLB - Credit Variables - 1991"
quietly use "Z:/data/Products/SLB/2021_10/Output/Data/SLB_C_YBNK_19902020_OCT21_QB1_V01.dta", clear
quietly keep if year== 1991
describe

di _new _new "SLB - Credit Variables - 1992"
quietly use "Z:/data/Products/SLB/2021_10/Output/Data/SLB_C_YBNK_19902020_OCT21_QB1_V01.dta", clear
quietly keep if year== 1992
describe

di _new _new "SLB - Credit Variables - 1993"
quietly use "Z:/data/Products/SLB/2021_10/Output/Data/SLB_C_YBNK_19902020_OCT21_QB1_V01.dta", clear
quietly keep if year== 1993
describe

di _new _new "SLB - Credit Variables - 1994"
quietly use "Z:/data/Products/SLB/2021_10/Output/Data/SLB_C_YBNK_19902020_OCT21_QB1_V01.dta", clear
quietly keep if year== 1994
describe

di _new _new "SLB - Credit Variables - 1995"
quietly use "Z:/data/Products/SLB/2021_10/Output/Data/SLB_C_YBNK_19902020_OCT21_QB1_V01.dta", clear
quietly keep if year== 1995
describe

di _new _new "SLB - Credit Variables - 1996"
quietly use "Z:/data/Products/SLB/2021_10/Output/Data/SLB_C_YBNK_19902020_OCT21_QB1_V01.dta", clear
quietly keep if year== 1996
describe

di _new _new "SLB - Credit Variables - 1997"
quietly use "Z:/data/Products/SLB/2021_10/Output/Data/SLB_C_YBNK_19902020_OCT21_QB1_V01.dta", clear
quietly keep if year== 1997
describe

di _new _new "SLB - Credit Variables - 1998"
quietly use "Z:/data/Products/SLB/2021_10/Output/Data/SLB_C_YBNK_19902020_OCT21_QB1_V01.dta", clear
quietly keep if year== 1998
describe

di _new _new "SLB - Credit Variables - 1999"
quietly use "Z:/data/Products/SLB/2021_10/Output/Data/SLB_C_YBNK_19902020_OCT21_QB1_V01.dta", clear
quietly keep if year== 1999
describe

di _new _new "SLB - Credit Variables - 2000"
quietly use "Z:/data/Products/SLB/2021_10/Output/Data/SLB_C_YBNK_19902020_OCT21_QB1_V01.dta", clear
quietly keep if year== 2000
describe

di _new _new "SLB - Credit Variables - 2001"
quietly use "Z:/data/Products/SLB/2021_10/Output/Data/SLB_C_YBNK_19902020_OCT21_QB1_V01.dta", clear
quietly keep if year== 2001
describe

di _new _new "SLB - Credit Variables - 2002"
quietly use "Z:/data/Products/SLB/2021_10/Output/Data/SLB_C_YBNK_19902020_OCT21_QB1_V01.dta", clear
quietly keep if year== 2002
describe

di _new _new "SLB - Credit Variables - 2003"
quietly use "Z:/data/Products/SLB/2021_10/Output/Data/SLB_C_YBNK_19902020_OCT21_QB1_V01.dta", clear
quietly keep if year== 2003
describe

di _new _new "SLB - Credit Variables - 2004"
quietly use "Z:/data/Products/SLB/2021_10/Output/Data/SLB_C_YBNK_19902020_OCT21_QB1_V01.dta", clear
quietly keep if year== 2004
describe

di _new _new "SLB - Credit Variables - 2005"
quietly use "Z:/data/Products/SLB/2021_10/Output/Data/SLB_C_YBNK_19902020_OCT21_QB1_V01.dta", clear
quietly keep if year== 2005
describe

di _new _new "SLB - Credit Variables - 2006"
quietly use "Z:/data/Products/SLB/2021_10/Output/Data/SLB_C_YBNK_19902020_OCT21_QB1_V01.dta", clear
quietly keep if year== 2006
describe

di _new _new "SLB - Credit Variables - 2007"
quietly use "Z:/data/Products/SLB/2021_10/Output/Data/SLB_C_YBNK_19902020_OCT21_QB1_V01.dta", clear
quietly keep if year== 2007
describe

di _new _new "SLB - Credit Variables - 2008"
quietly use "Z:/data/Products/SLB/2021_10/Output/Data/SLB_C_YBNK_19902020_OCT21_QB1_V01.dta", clear
quietly keep if year== 2008
describe

di _new _new "SLB - Credit Variables - 2009"
quietly use "Z:/data/Products/SLB/2021_10/Output/Data/SLB_C_YBNK_19902020_OCT21_QB1_V01.dta", clear
quietly keep if year== 2009
describe

di _new _new "SLB - Credit Variables - 2010"
quietly use "Z:/data/Products/SLB/2021_10/Output/Data/SLB_C_YBNK_19902020_OCT21_QB1_V01.dta", clear
quietly keep if year== 2010
describe

di _new _new "SLB - Credit Variables - 2011"
quietly use "Z:/data/Products/SLB/2021_10/Output/Data/SLB_C_YBNK_19902020_OCT21_QB1_V01.dta", clear
quietly keep if year== 2011
describe

di _new _new "SLB - Credit Variables - 2012"
quietly use "Z:/data/Products/SLB/2021_10/Output/Data/SLB_C_YBNK_19902020_OCT21_QB1_V01.dta", clear
quietly keep if year== 2012
describe

di _new _new "SLB - Credit Variables - 2013"
quietly use "Z:/data/Products/SLB/2021_10/Output/Data/SLB_C_YBNK_19902020_OCT21_QB1_V01.dta", clear
quietly keep if year== 2013
describe

di _new _new "SLB - Credit Variables - 2014"
quietly use "Z:/data/Products/SLB/2021_10/Output/Data/SLB_C_YBNK_19902020_OCT21_QB1_V01.dta", clear
quietly keep if year== 2014
describe

di _new _new "SLB - Credit Variables - 2015"
quietly use "Z:/data/Products/SLB/2021_10/Output/Data/SLB_C_YBNK_19902020_OCT21_QB1_V01.dta", clear
quietly keep if year== 2015
describe

di _new _new "SLB - Credit Variables - 2016"
quietly use "Z:/data/Products/SLB/2021_10/Output/Data/SLB_C_YBNK_19902020_OCT21_QB1_V01.dta", clear
quietly keep if year== 2016
describe

di _new _new "SLB - Credit Variables - 2017"
quietly use "Z:/data/Products/SLB/2021_10/Output/Data/SLB_C_YBNK_19902020_OCT21_QB1_V01.dta", clear
quietly keep if year== 2017
describe

di _new _new "SLB - Credit Variables - 2018"
quietly use "Z:/data/Products/SLB/2021_10/Output/Data/SLB_C_YBNK_19902020_OCT21_QB1_V01.dta", clear
quietly keep if year== 2018
describe

di _new _new "SLB - Credit Variables - 2019"
quietly use "Z:/data/Products/SLB/2021_10/Output/Data/SLB_C_YBNK_19902020_OCT21_QB1_V01.dta", clear
quietly keep if year== 2019
describe

di _new _new "SLB - Credit Variables - 2020"
quietly use "Z:/data/Products/SLB/2021_10/Output/Data/SLB_C_YBNK_19902020_OCT21_QB1_V01.dta", clear
...
```s/
    di _new _new "SLB - Credit Variables - 2001"
    quietly use "Z:/data/Products/SLB/2021_10/Output/Data/SLB_C_QBNK_20012020_OCT21_QB1_V01.dta", clear
